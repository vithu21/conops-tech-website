        ...
        <div className="mx-auto flex max-w-7xl flex-col gap-20 px-4 py-16 lg:px-8">
          ...
          >
            <div className="min-w-0 space-y-6">
              ...
              <div className="social-links flex flex-wrap items-center justify-center gap-6 sm:gap-8" aria-label="Social media links">
                <a
                  href="https://www.linkedin.com/company/conops-tech/"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="LinkedIn"
                  className="flex h-12 w-12 cursor-pointer items-center justify-center rounded-xl border border-white/10 bg-white/5 text-white/80 transition-all duration-200 hover:scale-110 hover:border-accent/40 hover:bg-accent/10 hover:text-accent focus:outline-none focus:ring-2 focus:ring-accent/50 sm:h-14 sm:w-14"
                >
                ...
                <a
                  ...
                  className="flex h-12 w-12 cursor-pointer items-center justify-center rounded-xl border border-white/10 bg-white/5 text-white/80 transition-all duration-200 hover:scale-110 hover:border-accent/40 hover:bg-accent/10 hover:text-accent focus:outline-none focus:ring-2 focus:ring-accent/50 sm:h-14 sm:w-14"
                >
                  <svg className="h-6 w-6 sm:h-7 sm:w-7 [&>path]:fill-current" viewBox="0 0 24 24" aria-hidden xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="relative z-10 mx-auto max-w-7xl px-4 py-16 lg:px-8">
            ...
            <div className="rounded-3xl border border-white/10 bg-white/5 p-8 backdrop-blur-xl lg:p-12">
              ...
              <div className="mt-12 flex flex-col items-center justify-between gap-6 border-t border-white/10 pt-8 sm:flex-row">
                ...
                {/* Social Links */}
                <div className="footer-social flex items-center justify-center gap-4" aria-label="Social media links">
                  <a 
                    href="https://www.linkedin.com/company/conops-tech/" 
                    target="_blank"
                    rel="noopener noreferrer"
